...
export const LoginForm = ({ disabled = false }: ILoginFormProps) => {
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-1 py-1 lg:px-1">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <Image
          ...
          priority
        />
        <h2 className="text-center mx-2 mb-6 text-2xl font-bold leading-9 tracking-tight text-gray-900">
